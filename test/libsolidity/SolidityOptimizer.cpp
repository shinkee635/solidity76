...
protected:
	...
	h32B m_optimizedContract;
	h32B m_nonOptimizedContract;
};
	...
	char const* sourceCode = R"(
		contract C {
			...
			function set() public returns (uint) {
				m_a = uint256(0x77abc0000000000000000000000000000000000000000000000000000000001);
				m_b = uint256(0x817416927846239487123469187231298734162934871263941234127518276);
				g();
				return 1;
			}
			function g() public {
				m_b = uint256(0x817416927846239487123469187231298734162934871263941234127518276);
				m_c = uint256(0x817416927846239487123469187231298734162934871263941234127518276);
				h();
			}
			function h() public {
				m_d = uint256(0xff05694900000000000000000000000000000000000000000000000000000000);
			}
...
BOOST_AUTO_TEST_CASE(constant_optimization_early_exit)
{
	...
	contract HexEncoding {
		function hexEncodeTest(address addr) public returns (bytes32 ret) {
			...
			// Nibble interleave
			x = x & uint256(0x00000000000000000000000000000000ffffffffffffffffffffffffffffffff);
			x = (x | (x * 2**64)) & uint256(0x0000000000000000ffffffffffffffff0000000000000000ffffffffffffffff);
			x = (x | (x * 2**32)) & uint256(0x00000000ffffffff00000000ffffffff00000000ffffffff00000000ffffffff);
			x = (x | (x * 2**16)) & uint256(0x0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff);
			x = (x | (x * 2** 8)) & uint256(0x00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff);
			x = (x | (x * 2** 4)) & uint256(0x0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f);

			// Hex encode
			uint h = (x & uint256(0x0808080808080808080808080808080808080808080808080808080808080808)) / 8;
			uint i = (x & uint256(0x0404040404040404040404040404040404040404040404040404040404040404)) / 4;
			uint j = (x & uint256(0x0202020202020202020202020202020202020202020202020202020202020202)) / 2;
			x = x + (h & (i | j)) * 0x27 + uint256(0x3030303030303030303030303030303030303030303030303030303030303030);
			...
			// Hex encode
			h = (x & uint256(0x0808080808080808080808080808080808080808080808080808080808080808)) / 8;
			i = (x & uint256(0x0404040404040404040404040404040404040404040404040404040404040404)) / 4;
			j = (x & uint256(0x0202020202020202020202020202020202020202020202020202020202020202)) / 2;
			x = x + (h & (i | j)) * 0x27 + uint256(0x3030303030303030303030303030303030303030303030303030303030303030);
