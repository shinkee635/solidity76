	...
	char const* sourceCode = R"(
		contract C {
			...
			function set() public returns (uint) {
				m_a = uint(0x77abc0000000000000000000000000000000000000000000000000000000001);
				m_b = uint(0x817416927846239487123469187231298734162934871263941234127518276);
				g();
				return 1;
			}
			function g() public {
				m_b = uint(0x817416927846239487123469187231298734162934871263941234127518276);
				m_c = uint(0x817416927846239487123469187231298734162934871263941234127518276);
				h();
			}
			function h() public {
				m_d = uint(0xff05694900000000000000000000000000000000000000000000000000000000);
			}
