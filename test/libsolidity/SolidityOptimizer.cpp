	...
	char const* sourceCode = R"(
		contract C {
			...
			function set() public returns (uint) {
				m_a = 0x00077abc0000000000000000000000000000000000000000000000000000000001;
				m_b = 0x000817416927846239487123469187231298734162934871263941234127518276;
				g();
				return 1;
			}
			function g() public {
				m_b = 0x000817416927846239487123469187231298734162934871263941234127518276;
				m_c = 0x000817416927846239487123469187231298734162934871263941234127518276;
				h();
			}
			function h() public {
				m_d = 0x00ff05694900000000000000000000000000000000000000000000000000000000;
			}
...
BOOST_AUTO_TEST_CASE(constant_optimization_early_exit)
{
	...
	contract HexEncoding {
		function hexEncodeTest(address addr) public returns (bytes32 ret) {
			...
			// Nibble interleave
			x = x & 0x0000000000000000000000000000000000ffffffffffffffffffffffffffffffff;
			x = (x | (x * 2**64)) & 0x000000000000000000ffffffffffffffff0000000000000000ffffffffffffffff;
			x = (x | (x * 2**32)) & 0x0000000000ffffffff00000000ffffffff00000000ffffffff00000000ffffffff;
			x = (x | (x * 2**16)) & 0x000000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff;
			x = (x | (x * 2** 8)) & 0x0000ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff;
			x = (x | (x * 2** 4)) & 0x000f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f;

			// Hex encode
			uint h = (x & 0x000808080808080808080808080808080808080808080808080808080808080808) / 8;
			uint i = (x & 0x000404040404040404040404040404040404040404040404040404040404040404) / 4;
			uint j = (x & 0x000202020202020202020202020202020202020202020202020202020202020202) / 2;
			x = x + (h & (i | j)) * 0x27 + 0x003030303030303030303030303030303030303030303030303030303030303030;
			...
			// Hex encode
			h = (x & 0x000808080808080808080808080808080808080808080808080808080808080808) / 8;
			i = (x & 0x000404040404040404040404040404040404040404040404040404040404040404) / 4;
			j = (x & 0x000202020202020202020202020202020202020202020202020202020202020202) / 2;
			x = x + (h & (i | j)) * 0x27 + 0x003030303030303030303030303030303030303030303030303030303030303030;
