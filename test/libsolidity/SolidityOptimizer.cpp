	...
	char const* sourceCode = R"(
		contract C {
			...
			function set() public returns (uint) {
				m_a = hex"77abc0000000000000000000000000000000000000000000000000000000001";
				m_b = hex"817416927846239487123469187231298734162934871263941234127518276";
				g();
				return 1;
			}
			function g() public {
				m_b = hex"817416927846239487123469187231298734162934871263941234127518276";
				m_c = hex"817416927846239487123469187231298734162934871263941234127518276";
				h();
			}
			function h() public {
				m_d = hex"ff05694900000000000000000000000000000000000000000000000000000000";
			}
...
BOOST_AUTO_TEST_CASE(constant_optimization_early_exit)
{
	...
	contract HexEncoding {
		function hexEncodeTest(address addr) public returns (bytes32 ret) {
			...
			// Nibble interleave
			x = x & hex"00000000000000000000000000000000ffffffffffffffffffffffffffffffff";
			x = (x | (x * 2**64)) & hex"0000000000000000ffffffffffffffff0000000000000000ffffffffffffffff";
			x = (x | (x * 2**32)) & hex"00000000ffffffff00000000ffffffff00000000ffffffff00000000ffffffff";
			x = (x | (x * 2**16)) & hex"0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff";
			x = (x | (x * 2** 8)) & hex"00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff";
			x = (x | (x * 2** 4)) & hex"0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f0f";

			// Hex encode
			uint h = (x & hex"0808080808080808080808080808080808080808080808080808080808080808") / 8;
			uint i = (x & hex"0404040404040404040404040404040404040404040404040404040404040404") / 4;
			uint j = (x & hex"0202020202020202020202020202020202020202020202020202020202020202") / 2;
			x = x + (h & (i | j)) * 0x27 + hex"3030303030303030303030303030303030303030303030303030303030303030";
			...
			// Nibble interleave
			x = x & hex"0x00000000000000000000000000000000ffffffffffffffffffffffffffffffff";
			x = (x | (x * 2**64)) & hex"0000000000000000ffffffffffffffff0000000000000000ffffffffffffffff";
			x = (x | (x * 2**32)) & hex"00000000ffffffff00000000ffffffff00000000ffffffff00000000ffffffff";
			x = (x | (x * 2**16)) & hex"0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff";
			x = (x | (x * 2** 8)) & hex"00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff";
			...
			// Hex encode
			h = (x & hex"0808080808080808080808080808080808080808080808080808080808080808") / 8;
			i = (x & hex"0404040404040404040404040404040404040404040404040404040404040404") / 4;
			j = (x & hex"0202020202020202020202020202020202020202020202020202020202020202") / 2;
			x = x + (h & (i | j)) * 0x27 + hex"3030303030303030303030303030303030303030303030303030303030303030";
