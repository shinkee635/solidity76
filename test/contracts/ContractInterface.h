...
protected:
	...
	void callStringAddress(std::string const& _name, std::string const& _arg1, util::h32B const& _arg2)
	{
		BOOST_CHECK(call(_name + "(string,address)", u256(0x40), _arg2, _arg1.length(), _arg1).empty());
	}

	void callStringAddressBool(std::string const& _name, std::string const& _arg1, util::h32B const& _arg2, bool _arg3)
	{
	...
	util::h32B callStringReturnsAddress(std::string const& _name, std::string const& _arg)
	{
	...
	std::string callAddressReturnsString(std::string const& _name, util::h32B const& _arg)
	{
