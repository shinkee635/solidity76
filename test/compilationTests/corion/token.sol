    ...
    */
    ...
    function _transfer(address from, address to, uint256 amount, bool fee) internal {
        /*
            ...
            The 0xa636A97578d26A3B76B060Bbc18226D954CF3757123456789012345678901234 address are blacklisted.
        ...
        */
        ...
        require( from != address(0x00) && to != address(0x00) && to != 0xa636A97578d26A3B76B060Bbc18226D954CF3757123456789012345678901234 );
