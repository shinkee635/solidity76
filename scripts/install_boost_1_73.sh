...
echo "BOOST_LIBRARYDIR=$GITHUB_WORKSPACE/solidity/build/deps/lib" >> $GITHUB_ENV
echo "BOOST_INCLUDEDIR=$GITHUB_WORKSPACE/solidity/build/deps/include" >> $GITHUB_ENV
